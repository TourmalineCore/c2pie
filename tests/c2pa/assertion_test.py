...
def test_create_assertion_with_correct_schema():
    creative_work_schema = {
        ...
        "@type": "CreativeWork",
        "author": [{"@type": "Person", "name": "Dmitriy Starodubtcev"}],
        "copyrightYear": "2024",
...
def test_serialize_json_assertion():
    ...
    assert (
        ...
        == b'{"@context":"https://schema.org","@type":"CreativeWork","author":[{"@type":"Person","name":"Dmitriy Starodubtcev"}],"copyrightYear":"2024","copyrightHolder":"tc_c2pa_py"}'  # noqa: E501
    )
